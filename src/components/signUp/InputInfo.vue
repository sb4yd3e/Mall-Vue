  ...
  <div class="info-form">
     <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80" >
        <FormItem label="昵称" prop="nickname">
            <i-input v-model="formValidate.nickname" clearable size="large" placeholder="请输入昵称"></i-input>
        </FormItem>
<!--         <FormItem label="邮箱" prop="mail">
            <i-input v-model="formValidate.mail" clearable size="large" placeholder="请输入邮箱"></i-input>
        </FormItem> -->
...
export default {
  ...
  methods: {
    ...
    generateUsername () {
      let preFix = 'comeshop';
      let lastFix = new Date().getTime();
      return preFix + '_' + lastFix;
    },
    handleSubmit (name) {
      const father = this;
